...
class TestDirectiveLeakage:
    """Directive-leakage probe: non-speech directives must not surface in the transcript."""

    @pytest.mark.asyncio
    async def test_directive_leakage_flagged(self):
    ...
    @pytest.mark.asyncio
    async def test_framework_labels_are_not_flagged(self):
    ...
    @pytest.mark.asyncio
    async def test_clean_run_scores_zero_when_probe_surface_exists(self):
...
class TestTruncationRecovery:
    """Truncation-recovery probe: barge-in turns can only have heard a prefix."""

    @pytest.mark.asyncio
    async def test_truncation_recovery_flagged_on_barge_in_turn(self):
    ...
    @pytest.mark.asyncio
    async def test_partial_recovery_on_barge_in_turn_not_flagged(self):
...
class TestRegistryWiring:
    """Package wiring and degenerate inputs."""

    def test_metric_registered_via_diagnostic_package(self):
    ...
    @pytest.mark.asyncio
    async def test_no_common_turns_returns_error(self):
