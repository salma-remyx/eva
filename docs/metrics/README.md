...
| [`transcription_semantic_accuracy`](transcription_semantic_accuracy.md) | Deterministic | Speech Recognition | Meaning preservation of STT transcripts: CER + content-word semantic distance (0-1) |
