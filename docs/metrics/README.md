...
| [`stt_reference_leakage`](stt_reference_leakage.md) | Deterministic | Speech Recognition | Rate of STT turns recovering reference text the audio cannot support (0.0-1.0, lower is better) |
