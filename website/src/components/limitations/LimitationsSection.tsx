    ...
    items: [
      {
        ...
        description: 'Extend the existing CSM, ITSM, and HR domains beyond English by translating scenarios into additional languages and pairing them with multilingual user-simulator voices.',
      },
    ],
  },
  {
